...
#define cmap_UNI_UTF16_BMP 3 /* Plat-spec: Unicode 2.0 onwards semantics; UTF-16 BMP only */
#define cmap_UNI_UTF32 4     /* Plat-spec: Unicode 2.0 onwards semantics; UTF-32 */
